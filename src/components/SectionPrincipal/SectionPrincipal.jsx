...
const SectionPrincipal = () => {
    return (
        <div className='position-relative divPrincipal'>
            <section className='container-xl d-flex position-relative-- flex-row w-100 sectionPrincipal justify-content-between align-items-center'>
                <CardTitulo/>
                <div className='w-50-- bgImage'></div>
            </section>
