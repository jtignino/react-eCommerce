    ...
    return (
        <div className='container-xl pt-5'>
            ...
            <>
                    ...
                    <div className="card mb-5 pb-1" style={{ maxWidth: '600px' }}>
                        <div className="row g-0">
                            <div className="col-md-4 my-auto">
                                <img src={`../images/${prod.img}`} className="img-fluid rounded-start" alt="..." />
                            </div>
                            <div className="col-md-8">
                                <div className="card-body">
                                    ...
                                    <button className="d-grid btn btn-secondary my-3" onClick={() => removeItem(prod.id)}>Eliminar producto</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <button className="d-grid btn btn-secondary my-3" onClick={emptyCart}>Vaciar carrito</button>
